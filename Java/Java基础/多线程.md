...
public class TestAtomClass {
    ...
    public void Increment(){
        ...
        int currentValue;
        do{
            //If version not the same, revert the data
...
public class TestAtomicClass {
    ...
    public void Increment(){
        ...
        }while(!value.compareAndSet(expectedValue, updateValue));

        System.out.println("线程" + Thread.currentThread().getName() + ":" + value.get());
    }
